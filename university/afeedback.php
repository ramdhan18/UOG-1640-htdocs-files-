...
<body> 
<ul class= "topnav"><b>
  <li><a href="AdminCheck.php">View Student Feedbacks</a></li>
  <li><a href="AdminViewComment.php">View Stundet Comments</a></li>
  <li class="right"><a href="logout.php">Logout</a></li>
</b></ul>
<hr>
<form name="Register" action="afeedbackk.php" method="post" enctype="multipart/form-data">
<center><fieldset>

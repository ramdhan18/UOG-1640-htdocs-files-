...
<ul class= "topnav"><b>
    ...
    <li><a href="deleteadmin.php">Delete</a></li>
        <li><a href="adminViewComment.php">View Comment</a></li>
      <li class="right"><a href="logout.php">Logout</a></li>
    <li class="right"><a href="feedback.php">Post</a></li>
</b></ul>
<hr>
<form name="Register" action="postt.php" method="post" enctype="multipart/form-data">
<center><fieldset>
 ...
 <textarea name="afeedback" style="width:350px; height:200px;" placeholder="Share Info ." required="true"></textarea>
